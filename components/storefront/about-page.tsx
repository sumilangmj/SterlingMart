...
export function AboutPage() {
  ...
  if (content === undefined) {
    return <main className="about-page"><section className="shell about-loading" data-scroll-reveal="about-loading" aria-busy="true" aria-label="Loading our story"><span /><span /><span /></section></main>;
  }

  return (
    <main className="about-page">
      <section className="about-hero shell" data-scroll-reveal="about-hero">
        ...
        <div className="about-art" data-scroll-parallax role="img" aria-label="The SM Sterling Mart HD logo on warm gold marble">
      ...
      <section className="about-story shell" data-scroll-reveal="about-story" aria-labelledby="about-story-heading">
      ...
      <section className="about-values shell" data-scroll-reveal="about-values" aria-labelledby="about-values-heading">
      ...
      <section className="about-cta" data-scroll-reveal="about-cta"><div className="shell about-cta-inner"><div><p className="eyebrow">Begin your edit</p><h2>Find the piece that becomes part of your story.</h2></div><Link className="button button-light" href="/contact">Speak with the salon <span aria-hidden="true">↗</span></Link></div></section>
    </main>
  );
}
