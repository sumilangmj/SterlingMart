...
export function ContactPage() {
  ...
  if (content === undefined) {
    return <main className="contact-page shell" data-scroll-reveal="contact-loading"><div className="contact-loading" aria-busy="true" aria-label="Loading contact details"><span /><span /></div></main>;
  }
  ...
  return (
    <main className="contact-page shell">
      <section className="contact-heading" data-scroll-reveal="contact-heading" aria-labelledby="contact-heading">
      ...
      <section className="contact-layout" data-scroll-reveal="contact-layout">
